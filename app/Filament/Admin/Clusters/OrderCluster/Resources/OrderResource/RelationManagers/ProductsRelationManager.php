...
namespace App\Filament\Admin\Clusters\OrderCluster\Resources\OrderResource\RelationManagers;
        ...
        return ProductResource::table($table)
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('total')
                    ->label('Total Price')
                    ->formatStateUsing(fn($record): string => Money::prefixFormat($record->total)),
                ...
                Tables\Actions\AttachAction::make()
                    ->form(fn(Tables\Actions\AttachAction $action): array => [
                        ...
                        Forms\Components\Placeholder::make('total')
                            ->label('Total Price')
                            ->content(fn(Get $get): string => Money::prefix($get('total'))),
                    ]),
            ])
            ->actions([
